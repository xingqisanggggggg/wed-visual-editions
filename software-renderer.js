...
export class SoftwareRenderer {
 ...
 triangles.sort((a,b)=>(a.mat.userData.layer||0)-(b.mat.userData.layer||0)||b.z-a.z);ctx.save();ctx.setTransform(this.ratio,0,0,this.ratio,0,0);ctx.beginPath();ctx.rect(v.x,v.y,v.w,v.h);ctx.clip();
